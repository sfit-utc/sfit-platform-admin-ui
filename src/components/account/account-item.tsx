...
export default function AccountItem({ account, style }: AccountItemProps) {
  ...
  if (style === "line") {
    return (
      <div className="flex justify-between items-center py-4 border-2 my-2">
        <div className="flex-2 text-center font-bold text-black text-2xl">
          {account.id}
        </div>
        <div className="flex-5 text-left font-bold text-black text-2xl whitespace-nowrap overflow-hidden text-ellipsis">
          {account.name}
        </div>
            ...
            <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-md shadow-lg z-10 min-w-full">
              <div className="p-1">
                {account.teams.map((team) => (
                  <div
                    key={team}
                    className="py-1 px-3 hover:bg-amber-50 rounded text-sm cursor-pointer text-gray-700"
                  >
                    {team}
                  </div>
                ))}
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 border ">
      <div className="flex items-center justify-between mb-3">
        <div className="text-lg font-bold text-gray-900">{account.id}</div>
      </div>
      ...
      <div className="mb-3 flex flex-col justify-center items-center">
        ...
        />
        <h3 className="my-3 font-semibold text-gray-800 text-lg mb-1">
          {account.name}
        </h3>
      ...
      <div className="flex justify-center space-x-2 mb-3">
        <button className="p-2 text-gray-600 hover:text-gray-700 hover:bg-gray-100 rounded-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            width="24"
      ...
      <div className="w-full text-center py-1 px-4 bg-green-100 text-green-600 rounded-full text-sm font-semibold whitespace-nowrap">
