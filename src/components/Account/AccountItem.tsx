...
export default function AccountItem({ account }: AccountItemProps) {
  ...
  return (
    <div className="flex justify-between items-center p-4 border-2 my-2 ">
      ...
      <div className="flex-1 cursor-pointer flex items-center justify-center">
        <svg
          ...
          fill="none"
        >
          <rect y="0.5" width="31" height="31" fill="url(#pattern0_1070_155)" />
          <defs>
            <pattern
      ...
      <div className="flex-1 cursor-pointer flex items-center justify-center">
        <svg
          ...
          fill="none"
        >
          <rect y="0.5" width="25" height="25" fill="url(#pattern0_1070_169)" />
          <defs>
            <pattern
