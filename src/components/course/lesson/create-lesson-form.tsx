    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (type === "Quiz") {
            data.quiz_content = form.quizContent.map((quiz: Quiz) => ({
                ...quiz,
                correct_answers: quiz.correctAnswers, // Ánh xạ correctAnswers thành correct_answers
            }));
            data.duration = Number(form.duration);
        }
        if (type === "Reading") {
        ...
        console.log("Data to submit:", data); // Kiểm tra dữ liệu trước khi gửi
        onSubmit(data);
    };
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            updatedQuizContent[questionIndex].question = e.target.value;
