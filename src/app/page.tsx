      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-4xl mx-auto leading-relaxed">
            Nền tảng học tập và quản lý thông minh dành cho sinh viên và giảng
            viên. Tham gia ngay để trải nghiệm những tính năng hiện đại và tiện
            ích nhất.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-green-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              Truy cập khóa học, tài liệu và bài tập mọi lúc, mọi nơi với giao
              diện thân thiện
            </p>
          </div>
          ...
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-green-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              Theo dõi kết quả học tập và tiến độ một cách dễ dàng, trực quan
            </p>
          </div>
          ...
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-green-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              Kết nối với bạn bè và thầy cô trong môi trường học tập hiện đại
            </p>
          </div>
        </div>
      </main>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-green-100 leading-relaxed">
                Nền tảng học tập hiện đại cho thế hệ sinh viên tương lai với
                công nghệ tiên tiến.
              </p>
            </div>
